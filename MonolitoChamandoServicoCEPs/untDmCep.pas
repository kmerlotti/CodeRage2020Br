...
type
  ...
  public
    function PesquisarCEP(const ACEP: string; var Logradouro: string; var Bairro: string; var Cidade: string; var UF: string): Boolean;
  end;
...
function TdmCep.PesquisarCEP(const ACEP: string; var Logradouro: string; var Bairro: string; var Cidade: string; var UF: string): Boolean;
begin
  result := False;
  ...
  try
    ...
    if (RESTResponse1.StatusCode = 200) and Assigned(RESTResponse1.JSONValue) then
    begin
      Logradouro := RESTResponse1.JSONValue.GetValue<string>('logradouro'); //FDMemTable1.FieldByName('logradouro').AsString;
